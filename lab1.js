...
assert('giraffe' > 'antelope', 'Should not of failed');
assert(1 === 'giraffe', 'Failed because 1 does not equal giraffe which is a string');
...
for (var x = 0; x < mealsPerDay.length; x++) {
  console.log('Avg Meals Today: ' + mealsPerDay[x]);
  if (mealsPerDay[x] < 4) {
    tooHungryDay = x + 1;
    break;
  }
